...
public class ExitTimeTicket implements TicketStrategy{
    ...
    //CONSTRUCTOR
    public ExitTimeTicket(final String carID, final LocalDateTime exitTime ) {
        
        setCarID(carID);
        this.ticketID = randomNumber.nextInt(999999)+ 100000;
        this.entryTime =   LocalDateTime.now();
        this.exitTime = exitTime;//LocalDateTime.of(2015, 10, 20, 7, 55, 6,123 );
        this.calcHours = true;
    }
...
//       ExitTimeTicket t = new ExitTimeTicket("CAR100", LocalDateTime.of(2015, 12, 12, 3, 00 ));
